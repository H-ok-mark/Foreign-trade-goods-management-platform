        ...
        <el-card class="stats-card" shadow="hover">
          <div class="card-content">
            ...
            <el-icon class="card-arrow">
              <ArrowUp v-if="goodsTrend === 'up'" class="text-success"></ArrowUp>
              <ArrowDown v-else-if="goodsTrend === 'down'" class="text-danger"></ArrowDown>
            </el-icon>
          </div>
        </el-card>
      </el-col>
      ...
      <el-col :span="6">
        <el-card class="stats-card" shadow="hover">
          <div class="card-content">
            ...
            <el-icon class="card-arrow">
              <ArrowUp v-if="orderTrend === 'up'" class="text-success"></ArrowUp>
              <ArrowDown v-else-if="orderTrend === 'down'" class="text-danger"></ArrowDown>
            </el-icon>
          </div>
        </el-card>
      </el-col>
      ...
      <el-col :span="6">
        <el-card class="stats-card" shadow="hover">
          <div class="card-content">
            ...
            <el-icon class="card-arrow">
              <ArrowUp v-if="customerTrend === 'up'" class="text-success"></ArrowUp>
              <ArrowDown v-else-if="customerTrend === 'down'" class="text-danger"></ArrowDown>
            </el-icon>
          </div>
        </el-card>
      </el-col>
    ...
    <el-row :gutter="20" class="chart-row">
      ...
      <el-col :span="12">
        <el-card class="chart-card">
          ...
          <div ref="inventoryTrendChartRef" class="chart-container"></div>
        </el-card>
      </el-col>
    </el-row>
          ...
          <el-table :data="latestOrders" style="width: 100%">
            ...
            <el-table-column prop="totalAmount" label="总金额" width="120">
              <template #default="scope">
                <span class="text-success">¥{{ scope.row.totalAmount }}</span>
              </template>
            </el-table-column>
      ...
      <el-col :span="12">
        <el-card class="table-card">
          ...
          <el-table :data="inventoryWarnings" style="width: 100%">
            ...
            <el-table-column prop="inventoryNumber" label="库存数量" width="100"></el-table-column>
            <el-table-column prop="minInventory" label="最低库存" width="100"></el-table-column>
            <el-table-column prop="difference" label="差值" width="80">
              <template #default="scope">
                <span class="text-danger">{{ scope.row.difference }}</span>
              </template>
            </el-table-column>
            <el-table-column label="操作" width="80">
              <template #default="scope">
                <el-button type="text" size="small" @click="handleReplenish(scope.row)">
                  补货
                </el-button>
              </template>
            </el-table-column>
...
import { ArrowUp, ArrowDown, Goods, Grid, Tickets, User } from '@element-plus/icons-vue'
...
const latestOrders = ref([
  { orderNumber: 'ORD2024001', customerName: 'ABC贸易公司', goodsName: '电子产品', totalAmount: 12500, status: '已完成' },
  { orderNumber: 'ORD2024002', customerName: 'XYZ进出口公司', goodsName: '服装', totalAmount: 8900, status: '待发货' },
  { orderNumber: 'ORD2024003', customerName: 'DEF贸易公司', goodsName: '食品', totalAmount: 5600, status: '已发货' },
  { orderNumber: 'ORD2024004', customerName: 'GHI进出口公司', goodsName: '电子产品', totalAmount: 15800, status: '待发货' },
  { orderNumber: 'ORD2024005', customerName: 'JKL贸易公司', goodsName: '家具', totalAmount: 23400, status: '已完成' }
])

// 库存预警数据
const inventoryWarnings = ref([
  { goodsName: '电子产品A', inventoryNumber: 5, minInventory: 20, difference: -15 },
  { goodsName: '服装B', inventoryNumber: 10, minInventory: 30, difference: -20 },
  { goodsName: '食品C', inventoryNumber: 8, minInventory: 25, difference: -17 },
  { goodsName: '家具D', inventoryNumber: 3, minInventory: 15, difference: -12 },
  { goodsName: '电子产品E', inventoryNumber: 12, minInventory: 35, difference: -23 }
])
